...
% This file was used to compare results of Table 6.4.1 In Haftka.
...
if i == 1
    ...
    [stress,dstdA] = Sensitivity(K,Kinv,E,L,c,s);
else
...
A = []; B = [];Aeq=[]; Beq=[];
options = optimset('Display','iter','TolFun',1e-6,'Algorithm','SQP','PlotFcns',@optimplotfval);
